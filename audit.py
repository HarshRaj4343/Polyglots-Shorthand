...
# ============================================================================
# audit.py - FINAL "EXAM" ON 24 BRAND-NEW MESSAGES
# ----------------------------------------------------------------------------
# Loads the trained model and scores it on audit.jsonl, which was written
# AFTER the model was finished, so it is an honest check on unseen data.
# ============================================================================
import json
...
# Load the audit rows and give each a unique group id (evaluate() expects one).
...
# Describe how this audit was done, then save the full results.
