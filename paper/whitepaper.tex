...
\title{\vspace{-1.2em}\textbf{The Polyglot's Shorthand}\\[0.3em]
  ...
  \normalsize\color{muted}Technical Whitepaper --- Q4, CS/AI Practice Problem Statements}
\author{Harsh Raj}
\date{September 2026}
...
PYTHON=.venv/bin/python ./run.sh   # data, 4 models, audit, 11 tests
\end{lstlisting}
...
(11 invariant tests). Bootstrap intervals, ECE and collision statistics in
...
\emo{angry} = U+1F621 / U+1F620. The system itself operates on the actual
code points.
